...
- 🧭 **侧边栏导航分类调整**：「工作」→「个人」（仅保留我的工作 & OKR），「管理」合并行政总览+重点专项+运营看板+周会+周报
- 🏢 **职场运营精简**：移除深圳职场，仅保留北京/武汉/异地 3 项
- 🚀 **新增完整单页应用**：`aop-full.html` 合并全部 10 个面板，一键体验所有功能
...
|------|:---:|:---:|
| 侧边栏分类 | 工作/管理 | **个人/管理** |
| 管理模块范围 | 运营看板+周会+周报 | **+行政总览+重点专项** |
| 职场运营 | 北京/武汉/异地/深圳 | **北京/武汉/异地** |
| 单页应用 | ❌ | ✅ **aop-full.html** |
| 事项详情交互 | 仅03页面 | ✅ 全面板可触发 |
| PPT 演示模式 | 仅07页面 | ✅ 任意面板可触发 |
