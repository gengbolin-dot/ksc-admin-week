...
```bash
export DATABASE_URL="postgresql://admin:Kingsoft0531@120.92.123.68:39944/project_codebuddy"
export PORT="8080"
```
...
服务将在 `http://120.92.123.190:8080` 启动。
...
```bash
curl -X POST http://120.92.123.190:8080/api/migrate-initial-data
```
